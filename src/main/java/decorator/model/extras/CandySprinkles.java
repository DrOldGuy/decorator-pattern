...
/**
 * This class represents candy sprinkles toppings. It implements the
 ...
 *
 */
public class CandySprinkles implements Extra, ConeIngredient {
   ...
   * @param parent
   */
  public CandySprinkles(ConeIngredient parent) {
    this.parent = parent;
  }
  ...
  public void serve() {
    parent.serve();
    System.out.println("I've added some candy sprinkles (yummy!).");
  }
}
