...
/**
 * This class represents a scoop of chocolate ice cream. It implements
 * the {@link Scoop} interface, which marks this class as an ice cream
 * scoop.
 * 
 * @author Promineo
 *
 */
public class ScoopOfChocolate implements Scoop, ConeIngredient {
   ...
   * @param parent
   */
  public ScoopOfChocolate(ConeIngredient parent) {
    this.parent = parent;
  }
  ...
  public void serve() {
    parent.serve();
    System.out.println("I've added a scoop of chocolate ice cream.");
  }
